...
function App() {
  ...
  return (
    <Layout>
      ...
      {/* Analyzer Section */}
      <section ref={analyzerRef} className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Error State */}
          {error && (
            <div className="mt-8 p-6 bg-danger-50 border border-danger-200 rounded-xl animate-fade-in">
              <div className="flex items-start space-x-3">
                <AlertCircle className="w-6 h-6 text-danger-500 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-semibold text-danger-800">Analysis Failed</h3>
                  <p className="text-danger-600 mt-1">{error}</p>
                  <button
                    onClick={handleReset}
                    className="mt-3 text-sm font-medium text-danger-700 hover:text-danger-800 flex items-center"
                  >
